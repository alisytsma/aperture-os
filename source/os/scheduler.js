...
(function (TSOS) {
    var Scheduler = /** @class */ (function () {
                ...
                if (this.cycleCount >= _CPU.quantum) {
                    ...
                    if (_Kernel.runningQueue.length > _CPU.runningPID + 1) {
                        ...
                        if (_CPU.program != null)
                            _KernelInterruptQueue.enqueue(new TSOS.Interrupt(CONTEXT_SWITCH, _CPU.program.processId));
                    }
        ...
        Scheduler.priorityAlgo = function () {
